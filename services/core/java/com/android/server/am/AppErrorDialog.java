...
final class AppErrorDialog extends BaseErrorDialog {
    ...
    static class Injector {
        static void sendFcReport(AppErrorDialog dialog, Message msg) {
            if (dialog.getProc() != null && dialog.mCrashInfo != null) {
                XoloErrorReport.sendFcErrorReport(dialog.getContext(), dialog.getProc(), dialog.mCrashInfo,
    ...
    public AppErrorDialog(Context context, ActivityManagerService service,
        ...
        if (app.errorReportReceiver != null) {
            setButton(DialogInterface.BUTTON_NEGATIVE,
                    res.getText(com.android.internal.R.string.report) + " XOLO",
    ...
    public AppErrorDialog(Context context, ActivityManagerService service, AppErrorResult result, ProcessRecord app,
        ...
        this(context, service, result, app);
        mCrashInfo = crashInfo;
        setButton(DialogInterface.BUTTON_POSITIVE, "Report Xolo", mHandler.obtainMessage(FORCE_QUIT_AND_REPORT)); 
        setButton(DialogInterface.BUTTON_NEGATIVE, "OK", mHandler.obtainMessage(FORCE_QUIT));
    }
