...
public class AudioProfileState {
	...
	//ymx add start: music volume
	public int mMusicVolume = 0;
	//ymx add end: music volume
    ...
    public static class Builder {
         ...
         * @return The builder
         */
        public Builder volume(int ringerVolume, int notificationVolume, int alarmVolume, int musicVolume) {
            this.mRingerVolume = ringerVolume;
            this.mNotificationVolume = notificationVolume;
            this.mAlarmVolume = alarmVolume;

			this.mMusicVolume = musicVolume;
    ...
    private AudioProfileState(Builder builder) {
		...
		mMusicVolume = builder.mMusicVolume;
    ...
    public String toString() {
		...
		buffer.append("volume_music = ").append(this.mMusicVolume).append(",");
