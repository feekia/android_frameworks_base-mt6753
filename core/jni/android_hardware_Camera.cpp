...
sp<Camera> get_native_camera(JNIEnv *env, jobject thiz, JNICameraContext** pContext)
{
    ...
    if (camera == 0) {
		/*add for bug 1438 by wangxuwei,begin*/
        //jniThrowRuntimeException(env,
                //"Camera is being used after Camera.release() was called");
        ALOGW("Camera is being used after Camera.release() was called");
        /*add for bug 1438 by wangxuwei,end*/		
    }
...
void MetadataCallbacksImp::getMetadata(JNIEnv *env, jobject thiz, jobject resultMetadataObj, jobject staticMetadataObj)
{
    ...
    if (CameraMetadata_setNativeMetadata(env, resultMetadataObj, &resultMetadata) != OK) {
        ...
        ALOGW("MtkJNICameraContext::getMetadata No native metadata defined for destRseultMetadata");
        /*add for bug 1438 by wangxuwei,end*/                
         return;
    }
    if (CameraMetadata_setNativeMetadata(env, staticMetadataObj, &characteristicMetadata) != OK) {
        ...
        ALOGW("MtkJNICameraContext::getMetadata No native metadata defined for destcharacteristicMetadata");
        /*add for bug 1438 by wangxuwei,end*/                  
         return;
    }
}
        ...
        JNIEnv *env, jbyteArray cbb, int msgType)
{
    ...
    if (cbb != NULL) {
        ...
        ALOGW("Unsupported message type");
        /*add for bug 1438 by wangxuwei,end*/                            
                return;
            }
        }
    ...
    jobject weak_this, jint cameraId, jint halVersion, jstring clientPackageName)
{
    ...
    if (clazz == NULL) {
        ...
        ALOGW("Can't find android/hardware/Camera");
        /*add for bug 1438 by wangxuwei,end*/         
...
static void android_hardware_Camera_setPreviewSurface(JNIEnv *env, jobject thiz, jobject jSurface)
{
    ...
    if (camera->setPreviewTarget(gbp) != NO_ERROR) {
        ...
        ALOGW("setPreviewTexture failed");
        /*add for bug 1438 by wangxuwei,end*/         
    }
}
        ...
        jobject thiz, jobject jSurface)
{
    ...
    if (camera->setPreviewCallbackTarget(gbp) != NO_ERROR) {
        ...
        ALOGW("setPreviewCallbackTarget failed");
        /*add for bug 1438 by wangxuwei,end*/         
    }
}
...
static jstring android_hardware_Camera_getParameters(JNIEnv *env, jobject thiz)
{
    ...
    if (params8.isEmpty()) {
        ...
        ALOGW("getParameters failed (empty parameters)");
        /*add for bug 1438 by wangxuwei,end*/          
        return 0;
    }
...
static void android_hardware_Camera_startSmoothZoom(JNIEnv *env, jobject thiz, jint value)
{
    ...
    if (rc == BAD_VALUE) {
        ...
        ALOGW("java/lang/IllegalArgumentException %s",msg);
        /*add for bug 1438 by wangxuwei,end*/         
    } else if (rc != NO_ERROR) {
    	/*add for bug 1438 by wangxuwei,begin*/
        //jniThrowRuntimeException(env, "start smooth zoom failed");
        ALOGW("start smooth zoom failed");
        /*add for bug 1438 by wangxuwei,end*/                 
    }
}
        ...
        jint value)
{
    ...
    if (camera->sendCommand(CAMERA_CMD_SET_DISPLAY_ORIENTATION, value, 0) != NO_ERROR) {
        ...
        ALOGW("set display orientation failed");
        /*add for bug 1438 by wangxuwei,end*/         
    }
}
        ...
        jboolean enabled)
{
    ...
    if (rc == NO_ERROR) {
        ...
        ALOGW("enable shutter sound failed");
        /*add for bug 1438 by wangxuwei,end*/           
        return JNI_FALSE;
    }
}
        ...
        jint type)
{
    ...
    if (rc == BAD_VALUE) {
        ...
        ALOGW("start face detection failed");
        /*add for bug 1438 by wangxuwei,end*/          
    }
}
...
static void android_hardware_Camera_stopFaceDetection(JNIEnv *env, jobject thiz)
{
    ...
    if (camera->sendCommand(CAMERA_CMD_STOP_FACE_DETECTION, 0, 0) != NO_ERROR) {
        ...
        ALOGW("stop face detection failed");
        /*add for bug 1438 by wangxuwei,end*/         
    }
}
...
static void android_hardware_Camera_enableFocusMoveCallback(JNIEnv *env, jobject thiz, jint enable)
{
    ...
    if (camera->sendCommand(CAMERA_CMD_ENABLE_FOCUS_MOVE_MSG, enable, 0) != NO_ERROR) {
        ...
        //jniThrowRuntimeException(env, "enable focus move callback failed");
         ALOGW("enable focus move callback failed");
        /*add for bug 1438 by wangxuwei,end*/         
    }
}
...
static void android_hardware_Camera_cancelContinuousShot(JNIEnv *env, jobject thiz)
{
    ...
    if (camera->sendCommand(CAMERA_CMD_CANCEL_CSHOT, 0, 0) != NO_ERROR) {
		...
		//jniThrowException(env, "java/lang/RuntimeException", "cancel ContinuousShot failed");
         ALOGW("cancel ContinuousShot failed");
        /*add for bug 1438 by wangxuwei,end*/		
    }
}
...
static void android_hardware_Camera_setContinuousShotSpeed(JNIEnv *env, jobject thiz, jint value)
{
    ...
    if (camera->sendCommand(CAMERA_CMD_SET_CSHOT_SPEED, value, 0) != NO_ERROR) {
		...
		//jniThrowException(env, "java/lang/RuntimeException", "setContinuousShotSpeed failed");
         ALOGW("setContinuousShotSpeed failed");
        /*add for bug 1438 by wangxuwei,end*/			
    }
}
